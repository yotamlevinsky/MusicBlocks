...
export const BLOCK_LIBRARY: Record<string, BlockDefinition> = {
  ...
  // Bank of Bars - MusicXML Import (Shades of Blue)
  bar_01: {
    blockId: "bar_01",
    name: "Opening C",
    ticks: 4,
    ...
    pattern: [
      { time: 0, note: "C4", duration: 0.9 },
      { time: 1, note: "C4", duration: 0.4 },
      { time: 1.5, note: "C4", duration: 0.4 },
      { time: 2, note: "C4", duration: 0.9 },
      { time: 3, note: "C4", duration: 0.9 },
    ],
  },
  bar_02: {
    ...
    color: "#BBDEFB",
    pattern: [
      { time: 0, note: "F4", duration: 0.4 },
      { time: 0.5, note: "F4", duration: 0.4 },
      { time: 1, note: "F4", duration: 0.4 },
      { time: 1.5, note: "F4", duration: 0.4 },
      { time: 2, note: "F4", duration: 0.9 },
      { time: 3, note: "F4", duration: 0.9 },
    ],
  },
  bar_03: {
    ...
    pattern: [
      ...
      { time: 0.5, note: "G4", duration: 0.4 },
      { time: 1, note: "G4", duration: 0.9 },
      { time: 2, note: "G4", duration: 1.8 },
    ],
  },
  bar_04: {
    blockId: "bar_04",
    ...
    color: "#64B5F6",
    pattern: [
      { time: 0, note: "C4", duration: 3.8 },
    ],
  },
  bar_05: {
    blockId: "bar_05",
    name: "Descending Triad",
    ticks: 4,
    color: "#42A5F5",
    pattern: [
      { time: 0, note: "C5", duration: 0.9 },
      { time: 1, note: "G4", duration: 0.9 },
      { time: 2, note: "E4", duration: 1.8 },
    ],
  },
  bar_06: {
    blockId: "bar_06",
    ...
    color: "#2196F3",
    pattern: [
      { time: 0, note: "F4", duration: 0.9 },
      { time: 1, note: "A4", duration: 0.4 },
      { time: 1.5, note: "C4", duration: 0.4 },
      { time: 2, note: "F4", duration: 1.8 },
    ],
  },
  bar_07: {
    blockId: "bar_07",
    ...
    color: "#1E88E5",
    pattern: [
      { time: 0, note: "B4", duration: 0.9 },
      { time: 1, note: "G4", duration: 0.9 },
      { time: 2, note: "D4", duration: 1.8 },
    ],
  },
  bar_08: {
    blockId: "bar_08",
    ...
    pattern: [
      { time: 0, note: "C4", duration: 0.9 },
      { time: 1, note: "D4", duration: 0.9 },
      { time: 2, note: "E4", duration: 0.4 },
      { time: 2.5, note: "F4", duration: 0.4 },
      { time: 3, note: "G4", duration: 0.4 },
      { time: 3.5, note: "A4", duration: 0.4 },
    ],
  },
  bar_09: {
    blockId: "bar_09",
    ...
    color: "#1565C0",
    pattern: [
      { time: 0, note: "G4", duration: 0.9 },
      { time: 1, note: "F4", duration: 0.9 },
      { time: 2, note: "E4", duration: 0.4 },
      { time: 2.5, note: "D4", duration: 0.4 },
      { time: 3, note: "E4", duration: 0.4 },
      { time: 3.5, note: "F4", duration: 0.4 },
    ],
  },
  bar_10: {
    blockId: "bar_10",
    ...
    pattern: [
      { time: 0, note: "G4", duration: 0.4 },
      { time: 0.5, note: "A4", duration: 0.4 },
      { time: 1, note: "B4", duration: 0.4 },
      { time: 1.5, note: "A4", duration: 0.4 },
      { time: 2, note: "G4", duration: 0.4 },
      { time: 2.5, note: "F4", duration: 0.4 },
      { time: 3, note: "E4", duration: 0.4 },
      { time: 3.5, note: "D4", duration: 0.4 },
    ],
  },
  bar_11: {
    blockId: "bar_11",
    ...
    pattern: [
      { time: 0, note: "E4", duration: 0.4 },
      { time: 0.5, note: "E4", duration: 0.4 },
      { time: 1, note: "E4", duration: 0.9 },
      { time: 2, note: "E4", duration: 0.4 },
      { time: 2.5, note: "E4", duration: 0.4 },
      { time: 3, note: "E4", duration: 0.9 },
    ],
  },
  bar_12: {
    blockId: "bar_12",
    ...
    pattern: [
      { time: 0, note: "D4", duration: 0.9 },
      { time: 1, note: "G4", duration: 0.9 },
      { time: 2, note: "B4", duration: 0.9 },
      { time: 3, note: "G4", duration: 0.9 },
    ],
  },
};
